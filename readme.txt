...
Setup:
1. Create Gameobject
2. Add sprites as children (In order of distance from the player, the furthest away at the top)
3. Add ParallaxManager.cs to the parent
...
Tutorial: https://youtu.be/eblurvSZ9YI
